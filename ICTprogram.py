...
from LearningStage.experimentProgram import createFinal, tagChildrenValue,\
...
if __name__ == '__main__':
    ...
    tagChildrenValue(israeliChildrenList, swedishChildrenList, PICKLE_RANDOM_FOREST_FILE)
    ...
    tagChildrenValue(israeliChildrenList, swedishChildrenList, PICKLE_ADABOOST_FILE)
    ...
    tagChildrenValue(israeliChildrenList, swedishChildrenList, PICKLE_RECOMMENDED_FILE)

    tagIsraeliWithSwedish(israeliChildrenList, swedishChildrenList)

    # Forth Stage:
    fourthStage(israeliChildrenList, swedishChildrenList)
    createFinal(israeliChildrenList, swedishChildrenList, params, RecommendedAlgorithm, PICKLE_RECOMMENDED_FILE, True)
    tagChildrenValue(israeliChildrenList, swedishChildrenList, PICKLE_RECOMMENDED_FILE, True)
